...
# ---- inputs ----
UM_PARQUET = Path("/oak/stanford/groups/cyaolai/AbbyHartley/gfc_NFs/nebular_emission_model/scripts/extras/UM_comp/um_a0.911185_z0p1_conditions_logMge8.3.parquet")
