...
def main():
    ...
    fig.suptitle(r"Lightcone $\times$ NF luminosity functions vs Comparat+16 (box017 volume; open=mass-incomplete)", fontsize=14, y=1.0)
    fig.tight_layout(rect=[0, 0, 1, 0.97])
    out = REPO + "figs_ALTB/hiz_lc_lumfunc_v2.png"; fig.savefig(out, bbox_inches="tight", dpi=150); sp("Saved: " + out)
    sp("=== DONE ===")
